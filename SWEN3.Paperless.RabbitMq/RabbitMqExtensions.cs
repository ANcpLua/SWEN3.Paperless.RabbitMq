...
#pragma warning disable VSTHRD002 // DI container registration requires synchronous factory
...
#pragma warning restore VSTHRD002
        ...
        if (includeOcrResultStream)
            services.AddSseStream<OcrEvent>();
        if (includeGenAiResultStream)
